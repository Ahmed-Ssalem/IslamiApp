...
class QuranFragment : Fragment() {
    ...
    fun initSuraNamesRecycler() {
        ...
        // on click listener for every sura

        adapter.setOnTextClickListener(object : SuraAdapter.onItemClickListener {
            override fun onItemClick(position: Int, suraName: String) {
                val intent = Intent(context,SuraActivity::class.java)
                intent.putExtra(Constants.POSSITION_EXTRA, position)
